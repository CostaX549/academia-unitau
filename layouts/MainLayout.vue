...
const linksSecondaryNav = ref([
    { name: 'Agendamentos', url: '/home', icon: 'icon-park-outline:hamburger-button' },
    { name: 'Perfil', url: '/profile', icon: 'bi:person-fill' },
    { name: 'Analytics', url: '/', icon: 'tabler:brand-google-analytics' },
    { name: 'More', url: '/more', icon: '', img: userStore.image }
])

const linksMobile = ref([
    { name: 'Agendamentos', url: '/home', icon: 'icon-park-outline:hamburger-button', img: '' },
    { name: 'Perfil', url: '/profile', icon: 'fluent:shapes-48-regular', img: '' },
   
    { name: 'Mais', url: '/more', icon: '', img: userStore.image }
])
